...
class InterStateSalesController extends \BaseController {
    ...
    public function store()
    {
        ...
        if( Auth::user()->InterStateSales()->create(Input::except('_token','invoice_date_submit','total_charges' )) ){
    ...
    public function update($id)
    {
        ...
        if( Auth::user()->InterStateSales()->where('id',$id)->update(Input::except('_token','_method','invoice_date_submit','total_charges')) ){
