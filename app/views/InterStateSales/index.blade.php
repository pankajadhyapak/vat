    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success btn-sm" href="{{ URL::to('InterStateSales/' . $purchases->id) }}">View</a>

                <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                <a class="btn btn-small btn-info btn-sm" href="{{ URL::to('InterStateSales/' . $purchases->id . '/edit') }}">Edit</a>
                <a class="btn btn-small btn-danger btn-sm" href="{{ URL::to('InterStateSales/' . $purchases->id . '/delete') }}" onclick="javascript:return confirm('Are you sure you want to delete ?')"
                    >Delete</a>
