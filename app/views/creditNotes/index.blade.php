...
<div class="col-md-8 col-md-offset-2  bs-component">
    <table class="table table-striped table-bordered">
        ...
        @foreach($creditPurchases as $key => $purchases)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success btn-sm" href="{{ URL::to('creditNotes/' . $purchases->id) }}">View</a>

                <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                <a class="btn btn-small btn-info btn-sm" href="{{ URL::to('creditNotes/' . $purchases->id . '/edit') }}">Edit</a>
                <a class="btn btn-small btn-danger btn-sm" href="{{ URL::to('creditNotes/' . $purchases->id . '/delete') }}" onclick="javascript:return confirm('Are you sure you want to delete ?')"
                    >Delete</a>
